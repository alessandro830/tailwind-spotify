...
export function Footer() {
    return (
        ...
        <Image src="/album.jpg" width={56} height={56} alt="Capa da música Overdose do Artista Natori" />
        <div className="flex flex-col">
            <strong className="font-normal">Overdose</strong>
            <span className="text-xs text-zinc-400">Natori</span>
        </div>
        </div>
